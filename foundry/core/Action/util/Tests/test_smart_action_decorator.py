...
from foundry.core.Action.util.smart_action_decorator import smart_action_decorator
...
class TestClass:
    def __init__(self):
        self.value = 0
        self.add_one.create_action(self)
        self.add_value.create_action(self)

    @smart_action_decorator("add_one", "add_one")
    def add_one(self) -> int:
        self.value += 1
        return self.value

    @smart_action_decorator("add_value", "add_value")
