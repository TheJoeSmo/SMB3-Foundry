...
class TileSquareAssembly(Saver):
    ...
    def __str__(self) -> str:
        ...
        return f"{self.__class__.__name__}({self.name}, {self.tsa_offset}, {str(top_ptn_tbl)}, {str(btm_ptn_tbl)}, {[str(block) for block in self.blocks]})"
    ...
    def data(self) -> Tuple[str, int, Tuple[PatternTable, PatternTable], List[Block]]:
        ...
        @return: A tuple containing the name of the tile square assembly, its pattern tables, and its corresponding blocks.
        """
