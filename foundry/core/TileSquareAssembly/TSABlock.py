...
from foundry.core.Cursor.Cursor import Cursor, Connection, require_a_transaction
...
class TSABlock:
    ...
    def __str__(self) -> str:
        ...
        return f"{self.__class__.__name__}({TileSquareAssembly(self.tsa_block_id[0])}, {self.tsa_block_id[1]}, {str(self.block)})"
