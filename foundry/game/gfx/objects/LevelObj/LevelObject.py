...
from foundry.game.gfx.objects.LevelObj.AbstractLevelObject import (
    AbstractLevelObject,
    get_type_of_generator,
    get_orientation_of_generator,
)
...
_vertical_generator_orientations = [GeneratorType.VERTICAL]
...
def get_generators_expansion(index: int, orientation: int, bytes_len: int):
    ...
    elif GeneratorType(orientation) in [GeneratorType.VERTICAL, GeneratorType.DIAG_WEIRD]:
        return EXPANDS_VERT
    else:
        return EXPANDS_NOT
