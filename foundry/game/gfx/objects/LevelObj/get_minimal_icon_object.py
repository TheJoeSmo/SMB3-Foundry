...
def get_minimal_icon_object(
    ...
    max_count = 10
    while (
        any(block not in level_object.level_object_renderer.block_group_renderer.blocks for
            block in level_object.blocks) and level_object.level_object_renderer.width < 0x10
    ):
